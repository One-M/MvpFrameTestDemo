...
/**
 * Created by：XQyi on 2017/9/17 17:48
 * Use:
 */
...
//            message.setBackgroundColor(backgroundColor);//文字背景色
            view.setBackgroundColor(backgroundColor);//整体view背景色
        }
        return this;
    }
...
//            message.setBackgroundResource(background);//文字背景
            view.setBackgroundResource(background);//整体view背景
